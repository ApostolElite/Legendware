...
DWORD WINAPI main(PVOID base)
{
	...
	g_ctx.signatures =
	{
		...
		crypt_str("55 8B EC 8B 45 08 53 8B D9 56 8B 84 83 ? ? ? ? 83 F8 FF 74 1A 0F B7 F0"),
...
g_ctx.indexes =
{
	...
	//std::cout << crypt_str("Done! Go to cs:go");
...
/*
#include "../CSGO-EnginePrediction-master/EnginePredictionMinimalExample/EnginePredictionMinimalExample/sdk.hpp"
#include "../CSGO-EnginePrediction-master/EnginePredictionMinimalExample/EnginePredictionMinimalExample/vmt.h"
#include <thread>
...
__forceinline void setup_render()
{
	...
	fonts[LOGS] = create_font(crypt_str("Lucida Console"), 11, FW_MEDIUM, FONTFLAG_DROPSHADOW);
	...
	fonts[DAMAGE_MARKER] = create_font(crypt_str("Verdana"), 15, FW_HEAVY, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
